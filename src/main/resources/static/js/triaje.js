document.addEventListener('DOMContentLoaded', () => {
    ...
    async function alternarGrabacion() {
        ...
        try {
            ...
            agregarMensajeIA('No pude acceder al microfono. Revisa los permisos del navegador.');
            console.error(error);
        }
    }
    ...
    async function transcribirAudio() {
        ...
        try {
            ...
            agregarMensajeIA('No pude transcribir el audio. Intenta grabar de nuevo o escribe tu mensaje.');
            console.error(error);
        } finally {
